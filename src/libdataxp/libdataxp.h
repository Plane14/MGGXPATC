...
private:
    ...
    const bool m_logSkippedAirportFilterHits;
    ...
    shared_ptr<TrafficFlow> m_currentFlow;
public:
    explicit XPAirportReader(
        ...
        bool _logSkippedAirportFilterHits = true);
public:
