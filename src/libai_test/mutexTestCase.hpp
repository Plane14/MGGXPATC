...
public:
    ...
    MutexTestCase& whenDepartureChecksInAfterRoll() { m_when = WhenWhat::DepartureChecksInAfterRoll; return *this; }
...
private:
    ...
    void doAct()
    {
        ...
        case WhenWhat::DepartureChecksIn:
            ...
            break;
        case WhenWhat::DepartureChecksInAfterRoll:
