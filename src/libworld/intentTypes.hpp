...
namespace world
{
    ...
    class ControllerHandoffIntent : public Intent
    {
    public:
        static const int IntentCode = 1115;
    private:
        int m_newFrequencyKhz;
    public:
        ControllerHandoffIntent(
            uint64_t _id,
            uint64_t _replyToId,
            shared_ptr<Flight> _subjectFlight,
            shared_ptr<ControllerPosition> _subjectControl,
            shared_ptr<ControllerPosition> _targetControl,
            int _newFrequencyKhz
        ) : Intent(
                _id,
                _replyToId,
    ...
    public:
        int newFrequencyKhz() const { return m_newFrequencyKhz; }
        shared_ptr<ControllerPosition> targetControl() const { return subjectControl2(); }
        bool isCritical() const override { return true; }
    };

    class PilotCheckInWithRadarIntent : public Intent
    {
    public:
        static const int IntentCode = 1116;
    private:
        int m_altitudeFeet;
    public:
        PilotCheckInWithRadarIntent(
            uint64_t _id,
            shared_ptr<Flight> _subjectFlight,
            shared_ptr<ControllerPosition> _subjectControl,
            int _altitudeFeet
            ...
            m_altitudeFeet(_altitudeFeet)
        {
        }
    public:
        int altitudeFeet() const { return m_altitudeFeet; }
        bool isCritical() const override { return true; }
    };

    class ControllerRadarContactIntent : public Intent
    {
    public:
        static const int IntentCode = 1117;
    public:
        ControllerRadarContactIntent(
            uint64_t _id,
            uint64_t _replyToId,
            shared_ptr<Flight> _subjectFlight,
            shared_ptr<ControllerPosition> _subjectControl
